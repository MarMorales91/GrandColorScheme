...
button.addEventListener('click', function () {
    ...
    let nameOfColor = newColor[1].toString()
    let firstRGB = newColor[2]
    let secondRGB = newColor[3]
    let thirdRGB = newColor[4]
...
let allcolor = invert(firstRGB, secondRGB, thirdRGB)
    ...
    var ntc = {
      ...
      ntc.init();
      let result = ntc.name(nameOfColor);
      infoOne.innerText = newColor[1]
      infoTwo.innerText = result[1]
      infoThree.innerText = result[2]
      infoFour.innerText = result[3]


      rgb.style.color = allcolor;
      h2.style.color = allcolor;
      button.style.color = allcolor;
      form.style.color = allcolor;
      colorName.style.color = allcolor;
...
// let allcolor = invert(120, 136, 68)
